...
def alicia():
  if request.method == 'POST':
       ...
       print(result['pid'])
       res=alicia_encrypt(for_alicia)
       hash=res['Hash']
       requests.post('http://23.99.231.16:3000/api/org.acme.nucypher.Ipfshash', data = { "$class": "org.acme.nucypher.Ipfshash", "hash": hash,"pid": result['pid']})
